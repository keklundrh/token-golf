...
> **Note**: This project uses Podman instead of Docker. See [ADR 001](docs/ADRs/001-tech-stack.md) for rationale. If you prefer Docker, most commands work with `alias docker=podman`.
